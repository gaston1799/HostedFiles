-- final.lua
-- Auto-generated from newScript.lua with environment checks
if type(game)~="table" or game.PlaceId==nil then
    game = game or {}
    game.PlaceId = game.PlaceId or 0
    if not game.IsLoaded then function game:IsLoaded() return true end end
end
